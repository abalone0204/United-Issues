...
RSpec.describe Admin::PostsController, :type => :controller do
  ...
  describe "GET index" do
    it "assigns all admin_posts as @admin_posts" do
      ...
      expect(assigns(:admin_posts)).to eq([post])
    end
  end
  ...
  describe "GET new" do
    it "assigns a new admin_post as @admin_post" do
      ...
      expect(assigns(:admin_post)).to be_a_new(Admin::Post)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created admin_post as @admin_post" do
        post :create, {:admin_post => valid_attributes}, valid_session
        expect(assigns(:admin_post)).to be_a(Admin::Post)
        expect(assigns(:admin_post)).to be_persisted
      end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved admin_post as @admin_post" do
        post :create, {:admin_post => invalid_attributes}, valid_session
        expect(assigns(:admin_post)).to be_a_new(Admin::Post)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested admin_post" do
        post = Admin::Post.create! valid_attributes
        put :update, {:id => post.to_param, :admin_post => new_attributes}, valid_session
        post.reload
    ...
    describe "with invalid params" do
      it "assigns the admin_post as @admin_post" do
        post = Admin::Post.create! valid_attributes
        put :update, {:id => post.to_param, :admin_post => invalid_attributes}, valid_session
        expect(assigns(:admin_post)).to eq(post)
      end
